...
<Accordion icon="rocket" title="Test the API">
  ...
  2. **Create an API key**:
     ...
     Use the admin panel at http://localhost:3000/ to log in and generate API keys. Copy the key right away - it is shown only once and cannot be retrieved later.
